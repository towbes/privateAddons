return T {
	...
	T{	--hib
		...
		T{
			...
			T{level = 90, name = 'rowan round shield',},
		},
		--Tier 2
		T{
			T{level = 15, name = 'ferrite dirk',},
			T{level = 35, name = 'ferrite dagger',},
			T{level = 55, name = 'ferrite stiletto',},
			T{level = 75, name = 'ferrite hammer',},
			T{level = 90, name = 'elm round shield',},
		},
		--Tier 3
		T{
			T{level = 15, name = 'quartz dirk',},
			T{level = 35, name = 'quartz dagger',},
			T{level = 55, name = 'quartz stiletto',},
			T{level = 75, name = 'quartz hammer',},
			T{level = 90, name = 'oaken round shield',},
		},
		--Tier 4
		T{
			T{level = 15, name = 'dolomite dirk',},
			T{level = 35, name = 'dolomite dagger',},
			T{level = 55, name = 'dolomite stiletto',},
			T{level = 75, name = 'dolomite hammer',},
			T{level = 90, name = 'ironwood round shield',},
		},
		--Tier 5
		T{
			T{level = 15, name = 'cobalt dirk',},
			T{level = 35, name = 'cobalt dagger',},
			T{level = 55, name = 'cobalt stiletto',},
			T{level = 75, name = 'cobalt hammer',},
